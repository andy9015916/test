<template>
  <div id="app">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="#">久林針織</a>
...
export default {
  ...
  computed: {
    password: function() {
      console.log(this.navbar.idd, this.Sidebar.idd);
      if (this.navbar.idd == this.Sidebar.idd) {
        return this.Sidebar.p;
      } else return "no";
    }
  }
};
